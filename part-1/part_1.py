...
sentence1 = F'{book_name} is writen by {author}'
...
# Step 5 - Floats
# Now estimate what the retail value of your book would be at a store and replace the 
# "None" below with a float value of the price. (Doesn't have to be accurate.)
book_price = 20.69
# book_price = 17.99


# Step 6 - Booleans
# Now we will practice with booleans. Replace the "is_awesome" variable with a boolean.
# True if your book is awesome, False if your book is not awesome.
is_awesome = True
# is_awesome = True
